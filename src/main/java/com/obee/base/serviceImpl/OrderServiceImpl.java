...
import com.obee.base.service.OrderItemService;
import com.obee.base.service.OrderPayService;
...
public class OrderServiceImpl extends BaseDynamicServiceImpl<Order> implements OrderService {
    ...
    public void initBusinessRules() {
        ...
        this.registerChildHook("items", new ChildDataHook<OrderItem>() {
            @Override
            public void beforeAdd(OrderItem item) {
...
//                }
        ...
        this.registerChildHook("pays", new ChildDataHook<OrderPay>() {
            @Override
